                    ...
                    <div class="col-auto">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div class="d-flex align-items-center text-muted">
                                ...
                                <span class="fw-medium" id="cart-count">{{ $cartCount }} Item</span>
                            </div>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover align-middle mb-0">
                                                    <thead class="table-light">
                                                        <tr>
                                                            <th scope="col" class="ps-4" style="width: 45%;">Produk
                                                            </th>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-10">
                                <div class="card shadow-sm border-0">
                                    <div class="card-header bg-white py-3">
                                        <h4 class="mb-0 fw-semibold"><i class="fas fa-credit-card me-2"></i>Metode
                                            Pembayaran
                                        </h4>
                                    </div>
                                    <div class="card-body p-4">
                                        ...
                                        <div class="payment-proof mt-5" id="payment-proof-section"
                                            style="display: none;">
                                                        ...
                                                        <div class="payment-details mb-4">
                                                            ...
                                                            <div class="payment-instruction bg-white p-3 rounded border">
                                                                ...
                                                                <div id="bank-instructions" class="text-start">
                                                                    <p class="mb-2"><i
                                                                            class="fas fa-mobile-alt me-2"></i>Buka
                                                                        aplikasi
                                                                    ...
                                                                    <p class="mb-2"><i
                                                                        ...
                                                                        transfer</p>
                                                                    <p class="mb-2"><i
                                                                            class="fas fa-credit-card me-2"></i>Masukkan
                                                                        nomor
                                                                    ...
                                                                    <p class="mb-2"><i
                                                                        ...
                                                                        jumlah: <span id="payment-amount-display"
                                                                            class="fw-semibold"></span></p>
                                                                    <p class="mb-0"><i
                                                                            class="fas fa-check-circle me-2"></i>Konfirmasi
                                                                        dan
                                                                ...
                                                                <div id="ewallet-instructions" class="text-start d-none">
                                                                    <p class="mb-2"><i
                                                                        ...
                                                                        e-wallet Anda</p>
                                                                    <p class="mb-2"><i
                                                                            class="fas fa-qrcode me-2"></i>Pilih
                                                                        menu pembayaran atau scan QR</p>
                                                                    <p class="mb-2"><i
                                                                            class="fas fa-camera me-2"></i>Scan
                                                    ...
                                                    <div class="upload-section">
                                                        <div class="mb-3">
                                                            <label for="payment-proof"
                                                                class="form-label fw-semibold">Upload
                    ...
                    <div class="step-panel" data-step="3">
                        <div class="row justify-content-center">
                            <div class="col-lg-10">
                                <div class="card shadow-sm border-0">
                                    <div class="card-header bg-white py-3">
                                        <h4 class="mb-0 fw-semibold"><i class="fas fa-truck me-2"></i>Pilih Kurir
                                            Pengiriman
                                        </h4>
                                    </div>
                                    <div class="card-body p-4">
                                                    ...
                                                    <div class="kurir-option p-3 border rounded mb-3 recommended-kurir"
                                                        ...
                                                        <div class="form-check mb-0">
                                                            <input class="form-check-input" type="radio" name="kurir"
                                                                id="pilihan-penjual" value="pilihan-penjual"
                                                            ...
                                                            <label class="form-check-label w-100" for="pilihan-penjual">
                                                                <div
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div>
                                                                            <span class="fw-semibold">Pilihan
                                                                                Penjual</span>
                                                                            <span class="badge bg-success ms-2">
                                                                                <i
                                                                                    class="fas fa-crown me-1"></i>Rekomendasi
                                                                            </span>
                                                                        </div>
                                                                    </div>
