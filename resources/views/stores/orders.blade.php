...
@section('content')
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6 mb-3 mb-md-0">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control border-start-0" placeholder="Cari pesanan..." id="search-orders">
                                    </div>
                                </div>
                                <div class="col-md-6">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="order-list" id="active-orders">
                            @if(count($activeOrders) > 0)
                                ...
                                <div class="card shadow-sm border-0 mb-4 order-card" data-status="{{ $order['status'] }}" data-date="{{ $order['date'] }}" data-order="{{ $order['order_number'] }}">
                                    <div class="card-header bg-white py-3">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-md-6 text-md-end">
                                                <span class="text-muted small">{{ date('d M Y, H:i', strtotime($order['date'])) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body p-4">
                                        <div class="row align-items-center">
                                            <div class="col-lg-8">
                                                ...
                                                <div class="mt-3">
                                                    <div class="shipping-info">
                                                        <div class="d-flex align-items-center mb-2">
                                                            ...
                                                            <div>
                                                                <strong>{{ $order['shipping_method'] }} - {{ $order['tracking_number'] }}</strong>
                                                            </div>
                                                        </div>
                                                        <div class="d-flex align-items-center">
                                                            <i class="fas fa-map-marker-alt me-2 text-primary"></i>
                                                            <div>
                                                                <small class="text-muted">Sedang dalam perjalanan ke alamat tujuan</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mt-3">
                                                    <button class="btn btn-outline-secondary btn-sm" onclick="viewOrderDetail('{{ $order['order_number'] }}')">
                                            ...
                                            <div class="col-lg-4 mt-3 mt-lg-0">
                                                <div class="text-lg-end">
                                                    <div class="mb-2">
                                                        <span class="fw-semibold text-primary">Total: Rp {{ number_format($order['total'], 0, ',', '.') }}</span>
                                                    </div>

                                                    @if(isset($order['estimated_delivery']))
                                                    <div class="mb-2">
                                                        <small class="text-muted">
                                                            Estimasi tiba: {{ date('d M Y', strtotime($order['estimated_delivery'])) }}
                                                        </small>
                                                    </div>
                                                    @endif

                                                    <div class="d-flex flex-column gap-2">
                                                        <button class="btn btn-primary btn-sm" onclick="trackOrder('{{ $order['order_number'] }}')">
                                                            <i class="fas fa-map-marked-alt me-1"></i>Lacak Pengiriman
                                                        </button>
                                                        <button class="btn btn-outline-success btn-sm" onclick="confirmDelivery('{{ $order['order_number'] }}')">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-lg-8">
                                                            ...
                                                            <div class="flex-grow-1">
                                                                ...
                                                                <div class="mt-2 p-2 bg-light rounded">
                                                                    <div class="d-flex align-items-center mb-1">
                                                                        ...
                                                                        <small class="text-muted">{{ date('d M Y', strtotime($order['review']['created_at'])) }}</small>
                                                                    </div>
                                                                    <p class="mb-0 small">{{ $order['review']['comment'] }}</p>
                                                                </div>
                                                                @endif
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="shipping-info">
                                                        <div class="d-flex align-items-center mb-2">
                                                            <i class="fas fa-truck me-2
                                                                ...
                                                                @elseif($order['status'] == 'completed') text-success
                                                                @endif"></i>
                                                            <div>
                                                                <strong>{{ $order['shipping_method'] }} - {{ $order['tracking_number'] }}</strong>
                                                            </div>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div>
                                                                <small class="text-muted">
                                                                    ...
                                                                    Pesanan telah tiba pada {{ date('d M Y, H:i', strtotime($order['delivered_date'])) }}
                                                                    @elseif($order['status'] == 'completed')
                                                                    Pesanan telah diterima pada {{ date('d M Y, H:i', strtotime($order['delivered_date'])) }}
                                                                    @endif
                                                                </small>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <button class="btn btn-outline-info btn-sm" onclick="viewShippingProof('{{ $order['order_number'] }}')">
                                                        <i class="fas fa-file-invoice me-1"></i>Bukti Pengiriman
                                                    </button>
                                                    @endif

                                                    @if($order['status'] == 'completed')
                                                    <button class="btn btn-outline-success btn-sm" onclick="viewDeliveryProof('{{ $order['order_number'] }}')">
                                                    ...
                                                    @if($order['status'] == 'completed' && !isset($order['review']))
                                                    <button class="btn btn-warning btn-sm" onclick="openReviewModal('{{ $order['order_number'] }}', {{ json_encode($order['items']) }})">
                                                ...
                                                <div class="text-lg-end">
                                                    ...
                                                    <div class="mb-3">
                                                        <small class="
                                                            ...
                                                            @if($order['status'] == 'delivered')
                                                            Tiba pada {{ date('d M Y', strtotime($order['delivered_date'])) }}
                                                            @elseif($order['status'] == 'completed')
                                                            Diterima pada {{ date('d M Y', strtotime($order['delivered_date'])) }}
                                                            @endif
                                                        </small>
                                                    </div>
                                                    ...
                                                    <div class="d-flex gap-2 justify-content-lg-end">
                                                        ...
                                                        <button class="btn btn-outline-success btn-sm" onclick="buyAgain('{{ $order['order_number'] }}')">
    ...
    <div class="modal fade" id="shippingProofModal" tabindex="-1" aria-labelledby="shippingProofModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <script>
        ...
        function updateEmptyStates() {
            ...
            const visibleActiveOrders = document.querySelectorAll('#active-orders .order-card[style="display: block"]').length;
            const noActiveOrders = document.getElementById('no-active-orders');
            ...
            const visibleHistoryOrders = document.querySelectorAll('#order-history .order-card[style="display: block"]').length;
            const noHistoryOrders = document.getElementById('no-history-orders');
                            ...
                            <div class="d-flex align-items-center mb-1">
                                <div class="star-rating me-2">
                                    ${Array.from({length: 5}, (_, i) =>
                                        `<i class="fas fa-star ${i < firstProduct.rating ? 'text-warning' : 'text-muted'}"></i>`
                                    ).join('')}
                                </div>
                                <small class="text-muted">${new Date().toLocaleDateString('id-ID', { day: 'numeric', month: 'short', year: 'numeric' })}</small>
                            </div>
                            <p class="mb-0 small">${firstProduct.comment}</p>
                        </div>
                    `;
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <table class="table table-sm table-borderless">
                                <tr>
                                    <td class="text-muted" style="width: 120px;">No. Pesanan</td>
        ...
        function viewShippingProof(orderId) {
            const shippingProofContent = `
                <div class="text-center">
                    <h6 class="fw-semibold mb-3">Bukti Pengiriman - ${orderId}</h6>
                    <img src="https://images.unsplash.com/photo-1556742044-3c52d6e88c62?w=600&h=400&fit=crop"
                         alt="Bukti Pengiriman"
                         class="img-fluid rounded mb-3">
                    <p class="text-muted">Bukti pengiriman dari kurir untuk pesanan ${orderId}</p>
                    <div class="mt-3">
                        <button class="btn btn-primary" onclick="downloadImage('https://images.unsplash.com/photo-1556742044-3c52d6e88c62?w=600&h=400&fit=crop', 'bukti-pengiriman-${orderId}')">
        ...
        function viewDeliveryProof(orderId) {
            const deliveryProofContent = `
                <div class="text-center">
                    <h6 class="fw-semibold mb-3">Bukti Pesanan Diterima - ${orderId}</h6>
                    <img src="https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=600&h=400&fit=crop"
                         alt="Bukti Diterima"
                         class="img-fluid rounded mb-3">
                    <p class="text-muted">Bukti pesanan telah diterima untuk pesanan ${orderId}</p>
                    <div class="mt-3">
                        <button class="btn btn-primary" onclick="downloadImage('https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=600&h=400&fit=crop', 'bukti-diterima-${orderId}')">
                            <i class="fas fa-download me-2"></i>Download Bukti
                        </button>
                    </div>
                </div>
        ...
        function confirmDelivery(orderId) {
            if (confirm(`Konfirmasi bahwa pesanan ${orderId} telah diterima?`)) {
                showToast(`Pesanan ${orderId} dikonfirmasi telah diterima`, 'success');
        ...
        function buyAgain(orderId) {
            showToast(`Menambahkan produk dari pesanan ${orderId} ke keranjang`, 'success');
    ...
    <style>
        ...
        .tracking-step:not(.completed):not(.active) .step-icon {
            background-color: #e9ecef;
            color: #6c757d;
        }
