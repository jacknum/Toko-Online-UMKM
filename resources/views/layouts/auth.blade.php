...
<head>
    ...
    <style>
        ...
        /* Pastikan semua form group sejajar kiri */
        .register-form-group {
            position: relative;
            margin-bottom: 0;
            width: 100%;
        ...
        /* Pastikan form controls memiliki width 100% */
        ...
        /* Pastikan columns memiliki alignment yang konsisten */
        .form-columns {
            display: grid;
            grid-template-columns: 1fr 1fr;
            gap: 40px;
        ...
        /* Responsive design - pastikan alignment tetap konsisten */
